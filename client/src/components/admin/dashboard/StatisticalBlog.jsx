...
const AdminDashboard = ({ data }) => {
  ...
  return (
    <div className={`${color.outside} flex flex-col p-4 rounded-lg shadow-md`}>
      <h2 className="text-2xl font-semibold mb-4">Admin Dashboard</h2>
      <div className="grid grid-cols-5 gap-4">
        <div className={`flex flex-col items-center justify-center ${color.inside} rounded-lg shadow-md p-4`}>
          <div className="flex">
