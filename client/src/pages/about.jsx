    ...
    <div>
      ...
      <div className="mx-1 w-100">
        ...
        <div class="text-justify mt-10">
          <div class="text-2xl font-semibold">About BlogD</div>
          <div class="indent-6 my-4">
        ...
        <div className="my-w">
          <div class="text-2xl font-semibold">Some Category Popular</div>
          <ul class="list-decimal pl-8 mt-2">
            <li class="mb-2">
        ...
        <div className="my-4">
          <div class="text-2xl font-semibold">Comment And Feedback</div>
