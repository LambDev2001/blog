    ...
    <div className={themeColor.text}>
      ...
      <div
        ...
        <div className="relative">
          <div
            className={`${themeColor.sub} ${themeColor.border} border-1 py-2 px-3 rounded-md flex`}
          ...
          {modalType && (
            <div
              className={`${themeColor.sub} ${themeColor.border} border-1 absolute right-0 mt-2 flex flex-col w-[120px] rounded-md`}>
              <div
                className={`${themeColor.hover} p-2 my-1 mx-3 rounded-md flex cursor-pointer`}
                onClick={() => setType(1)}>
